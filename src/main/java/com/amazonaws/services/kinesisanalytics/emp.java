...
public class emp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3415979325403452490L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"emp\",\"namespace\":\"com.amazonaws.services.kinesisanalytics\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"salary\",\"type\":\"int\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"address\",\"type\":\"string\"}]}");
   ...
   */
  public static com.amazonaws.services.kinesisanalytics.emp.Builder newBuilder() {
    return new com.amazonaws.services.kinesisanalytics.emp.Builder();
  }
   ...
   * @return A new emp RecordBuilder
   */
  public static com.amazonaws.services.kinesisanalytics.emp.Builder newBuilder(com.amazonaws.services.kinesisanalytics.emp.Builder other) {
    return new com.amazonaws.services.kinesisanalytics.emp.Builder(other);
  }
   ...
   * @return A new emp RecordBuilder
   */
  public static com.amazonaws.services.kinesisanalytics.emp.Builder newBuilder(com.amazonaws.services.kinesisanalytics.emp other) {
    return new com.amazonaws.services.kinesisanalytics.emp.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<emp>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.amazonaws.services.kinesisanalytics.emp.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.amazonaws.services.kinesisanalytics.emp other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.amazonaws.services.kinesisanalytics.emp.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.amazonaws.services.kinesisanalytics.emp.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.amazonaws.services.kinesisanalytics.emp.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.amazonaws.services.kinesisanalytics.emp.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.amazonaws.services.kinesisanalytics.emp.Builder setSalary(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.amazonaws.services.kinesisanalytics.emp.Builder clearSalary() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.amazonaws.services.kinesisanalytics.emp.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.amazonaws.services.kinesisanalytics.emp.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.amazonaws.services.kinesisanalytics.emp.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.amazonaws.services.kinesisanalytics.emp.Builder clearAddress() {
      address = null;
